...
class GaussMarkerVisualizer(BaseVisualizer):
    ...
    def _resolve_channels(self, mask: torch.Tensor, requested_channel: Optional[int] = None) -> List[int]:
        if mask.dim() == 3:
    ...
    def _get_reversed_latent(self, step: Optional[int] = None) -> torch.Tensor:
